...
<form id="update">
	<table>
		<tr>
			<th colspan="2">用户道具信息修改</th>
		</tr>
		<tr>
			<th>用户ID</th>
			<th>
				<input type="hidden" name="userid" value="${prop.userid?c!}" />
				${prop.userid?c!}
			</th>
		</tr>
		<tr>
			<th>道具ID</th>
			<th>
				<input type="text" name="propid" value="${prop.propid?c!}" readonly="true"/>
			</th>
		</tr>
		<tr>
			<th>道具数量</th>
			<th>
				<input type="text" name="amount" value="${prop.amount?c!}" />
			</th>
		</tr>
	<table>
<form>
